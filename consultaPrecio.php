...
$sql = "SELECT * from vinos WHERE precio BETWEEN '$precioMinimo' AND '$precioMaximo' ORDER BY precio";
...
if ($result->num_rows > 0) {
    ...
    ?>
      ...
      <strong>Precio: </strong><?=$row['precio']?> €<br>
        ...
        <button onclick="document.getElementById('<?=$id?>').style.display='block'" class="w3-button w3-highway-red">Pedir</button>
...
?>
   ...
   <p><strong>No existe ningún vino para su consulta</strong><br></p> ;
    <?php
}
$conn->close();
  ?>
