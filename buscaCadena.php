...
<div class="w3-card-4 w3-section">
  ...
  <form action="consultaNombre.php" method="post">
  ...
  <p>      
    ...
    <input class="w3-input w3-border w3-sand w3-display-top" name="nombre" type="text" required style="margin-left:20px;width:90%"></p>
    <p>    
  <p>
